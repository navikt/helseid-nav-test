...
data class BusinessDocument(val businessDocument: String, val properties: Properties) {
    data class Properties(val system: System,val contentTransferEncoding: String = "base64",val contentType: String = APPLICATION_XML_VALUE,val ebxmlOverrides: EbxmlOverrides? = null) {
