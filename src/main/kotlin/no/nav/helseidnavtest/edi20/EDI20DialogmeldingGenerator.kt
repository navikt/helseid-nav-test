...
class EDI20DialogmeldingGenerator(private val marshaller: Jaxb2Marshaller,
    ...
    fun hodemelding(from: HerId, to: HerId, pasient: Fødselsnummer, vararg refs: Pair<URI, MediaType>): String {
        val msg = mapper.hodemelding(from, to, pasient(pasient), *refs)
