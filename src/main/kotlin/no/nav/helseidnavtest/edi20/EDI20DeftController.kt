...
@Tag(name = "EDI2.0 Deft",
    description = "Controller for å teste EDI2.0-Deft apiet, kaller videre til NHN-apiet med auth (Client Credential Flow) for valgt herId. Multipart-opplasting er ikke implementert",
