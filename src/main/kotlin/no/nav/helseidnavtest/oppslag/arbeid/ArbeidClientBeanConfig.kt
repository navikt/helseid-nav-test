...
class ArbeidClientBeanConfig {
    ...
    @Bean
    @Qualifier(ARBEID)
    fun arbeidClientCredentialsRequestInterceptor(clientManager: AuthorizedClientServiceOAuth2AuthorizedClientManager) = TokenExchangingRequestInterceptor(ARBEID, clientManager)
}