...
class NotFoundException(title: String = "Ikke funnet", detail: String? = null, uri: URI, cause: Throwable? = null) : IrrecoverableException(NOT_FOUND, title, detail, uri, cause)
open class IrrecoverableException(status: HttpStatus, title: String, detail: String? = null, uri: URI? = null, cause: Throwable? = null) : ErrorResponseException(status, problemDetail(status, title, detail, uri),  cause)
