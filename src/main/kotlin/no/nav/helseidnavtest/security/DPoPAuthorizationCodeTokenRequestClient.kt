...
) : OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest>
{
    ...
    override fun getTokenResponse(authorizationCodeGrantRequest: OAuth2AuthorizationCodeGrantRequest): OAuth2AccessTokenResponse
    {
        ...
        val response = dpopResponse(redirectURI, clientId, tokenURI, jwt)
    ...
    private fun dpopResponse(redirectURI: String, clientId: String, tokenURI: String, jwt: String): Map<String, String>
    {
        ...
        return restTemplate.exchange(tokenURI, HttpMethod.POST, httpEntity, mapResponseType
        ).body ?: emptyMap()
    }
}