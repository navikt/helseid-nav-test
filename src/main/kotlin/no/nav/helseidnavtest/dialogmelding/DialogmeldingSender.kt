...
@Component
class DialogmeldingSender(private val template: JmsTemplate,val generator: DialogmeldingGenerator, private val cfg: DialogmeldingConfig, private val lager: Dialogmeldinglager) {
