...
class DialogmeldingConfig(val request: String,val response: String, val host: String = "mqls02.preprod.local", val channel: String, val qm: String, val port: Int = 1413)  {
